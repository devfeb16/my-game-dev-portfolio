      ...
      <div className="grid grid-cols-1 md-cols-3 gap-6">
        {services.map((s) => {
          ...
          return (
            <div 
              key={s.title} 
              className={`group relative rounded-xl border-2 ${s.borderColor} bg-gradient-to-br from-[#0c0e14] to-[#0a0f14] p-6 transition-all duration-300 hover-[0_0_30px_rgba(34,211,238,0.2)] hover-[1.02] overflow-hidden`}
            >
              <div className="absolute inset-0 bg-gradient-to-br from-transparent via-transparent to-black/20 opacity-0 group-hover-100 transition-opacity duration-300"></div>
