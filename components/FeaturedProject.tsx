...
export default function FeaturedProject() {
  return (
    <section className="mx-auto mt-20 max-w-7xl px-6">
      ...
      <div className="group relative overflow-hidden rounded-2xl border border-neon-cyan/20 bg-gradient-to-br from-[#0c0e14]/90 via-[#0a0b0f]/90 to-[#0c0e14]/90 p-1 shadow-[0_0_60px_-15px_rgba(34,211,238,0.15)] transition-all duration-500 hover:border-neon-cyan/40 hover:shadow-[0_0_80px_-10px_rgba(34,211,238,0.3)]">
        {/* Animated border glow */}
        <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-neon-cyan/0 via-neon-cyan/10 to-neon-cyan/0 opacity-0 blur-xl transition-opacity duration-500 group-hover:opacity-100"></div>
        
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 rounded-xl bg-[#0a0b0f]/40 p-6 md:p-8 backdrop-blur-sm">
          {/* Image Section */}
          <div className="relative h-72 w-full overflow-hidden rounded-xl border border-neon-cyan/10 bg-gradient-to-br from-[#0c0e14] to-[#0a0b0f] shadow-inner">
            ...
            />
            {/* Overlay gradient */}
            <div className="absolute inset-0 bg-gradient-to-br from-neon-cyan/5 via-transparent to-neon-magenta/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          </div>
          ...
          <div className="flex flex-col justify-center space-y-6">
            ...
            <div className="flex flex-wrap gap-2">
              {["Unity", "C#", "URP", "Addressables"].map((tech, idx) => (
                <span 
                  key={tech}
                  className="rounded-lg border border-neon-blue/20 bg-neon-blue/5 px-3 py-1.5 text-xs font-medium text-neon-blue/90 backdrop-blur-sm transition-all duration-300 hover:border-neon-blue/40 hover:bg-neon-blue/10 hover:shadow-[0_0_15px_rgba(96,165,250,0.2)]"
            ...
            <div className="pt-2">
              <a 
                href="/projects" 
                className="group/btn inline-flex items-center gap-2 rounded-lg border border-neon-magenta/30 bg-gradient-to-r from-neon-magenta/10 to-transparent px-6 py-3 text-sm font-semibold text-neon-magenta transition-all duration-300 hover:border-neon-magenta/50 hover:bg-gradient-to-r hover:from-neon-magenta/20 hover:to-neon-magenta/10 hover:shadow-[0_0_25px_rgba(244,63,94,0.3)]"
              >
                See details
                <svg 
