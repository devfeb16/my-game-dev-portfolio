  ...
  return (
    <section className="mx-auto mt-24 max-w-7xl px-6">
      <div className="mb-10 flex items-center justify-between">
        ...
        <Link 
          href="/projects" 
          className="group flex items-center gap-2 rounded-lg border border-neon-cyan/30 bg-neon-cyan/5 px-4 py-2 text-sm font-semibold text-neon-cyan transition-all duration-300 hover:border-neon-cyan/50 hover:bg-neon-cyan/10 hover:shadow-[0_0_20px_rgba(34,211,238,0.25)]"
        >
          View all
          <svg 
