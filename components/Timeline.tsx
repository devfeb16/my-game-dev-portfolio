        ...
        {items.map((item, idx) => {
          ...
          return (
            <li key={item.year} className="relative pl-12">
              ...
              <div className={`rounded-lg border ${item.borderColor} bg-gradient-to-br from-[#0c0e14] to-[#0a0f14] p-4 transition-all duration-300 hover:shadow-[0_0_20px_rgba(34,211,238,0.15)] hover:scale-[1.01]`}>
