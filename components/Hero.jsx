...
export default function Hero({ className, headline, subtitle }) {
  ...
  return (
    <section
      className={`relative isolate min-h-[55vh] w-full overflow-hidden bg-[#0b0f12] ${className || ""}`}
      aria-label="Hero"
    >
      <HeroBackground />
      ...
      <div className="relative z-10 mx-0 grid max-w-none lg:max-w-none grid-cols-1 items-start gap-4 px-2 md:px-4 lg:px-6 pt-8 md:pt-10 lg:pt-12 pb-4 md:grid-cols-12">
      ...
      <div
        className={`mt-2 transition-all duration-700 ease-out ${showDetails ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4 pointer-events-none"}`}
