  ...
  return (
    <section className="mx-auto max-w-6xl px-6">
      <div className="relative rounded-xl border border-[var(--color-border)]/40 bg-gradient-to-br from-[#0d1218] to-[#0a0f14] p-8 overflow-hidden group">
        <div className="absolute inset-0 bg-gradient-to-r from-neon-cyan/5 via-transparent to-neon-magenta/5 opacity-0 group-hover-100 transition-opacity duration-500"></div>
        <div className="relative z-10">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="flex-1">
              <p className="text-zinc-300 leading-relaxed">
                ...
                dark joke. Consider this your friendly heads-up.
              </p>
            </div>
          </div>
          <div className="flex flex-wrap gap-3 mt-6 pt-6 border-t border-[var(--color-border)]/20">
            {traits.map((trait, idx) => {
              ...
              return (
                <div key={idx} className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#0c0e14]/60 border border-[var(--color-border)]/20 hover-[var(--color-border)]/40 transition-all duration-200">
