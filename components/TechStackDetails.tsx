...
const skills = [
  { 
    ...
    items: [
      ...
      { name: "C#", icon: FaCode },
      { name: "URP", icon: null },
      { name: "Addressables", icon: null },
      { name: "Profiling", icon: null },
    ]
  },
  { 
    group: "AI/ML", 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {skills.map((s) => {
          ...
          return (
            <div 
              key={s.group} 
              className={`group relative rounded-xl border-2 ${s.borderColor} bg-gradient-to-br from-[#0c0e14] to-[#0a0f14] p-6 transition-all duration-300 hover:shadow-[0_0_30px_rgba(34,211,238,0.15)] hover:scale-[1.02] overflow-hidden`}
            >
