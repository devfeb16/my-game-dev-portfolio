export default function PersonalityBanner() {
  return (
    <section className="mx-auto max-w-6xl px-6">
      <div className="rounded-xl border border-[var(--color-border)]/40 bg-[#0d1218] p-6">
        <p className="text-zinc-300">
          I’m a Unity mobile game developer at <span className="text-neon-cyan font-semibold">Pixls</span>, and when I’m not profiling
