      ...
      <div className="grid grid-cols-1 md-cols-2 gap-6">
        {fandoms.map((fandom, idx) => {
          ...
          return (
            <div 
              key={idx}
              className={`group relative rounded-xl border-2 ${fandom.borderColor} bg-gradient-to-br from-[#0c0e14] to-[#0a0f14] p-6 transition-all duration-300 hover-[0_0_30px_rgba(244,63,94,0.2)] hover-[1.02] overflow-hidden`}
            >
